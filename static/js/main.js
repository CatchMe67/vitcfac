          ...
          <button class="share-btn profile-share-inline" type="button" onclick='shareProfessor(${JSON.stringify(p.name)}, ${JSON.stringify(p.id)})' aria-label="Share this professor">
            <span class="share-icon-wh" aria-hidden="true">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="none" aria-hidden="true" focusable="false">
                <circle cx="12" cy="12" r="9.2" stroke="currentColor" stroke-width="1.4" fill="none"/>
                <path fill="currentColor" d="M15.1 13.6c-.2-.1-1.1-.5-1.3-.5-.2 0-.3 0-.5.2-.2.2-.6.5-.7.6-.1.1-.2.1-.3.1-.1 0-.4 0-.7-.2-.3-.2-1.3-.8-2.1-1.5-.7-.7-1.1-1.3-1.1-1.6 0-.3.1-.4.2-.5.1-.1.2-.1.3-.1.2-.1.3-.1.5-.1.2 0 .4 0 .5 0 .2 0 .4-.1.6-.1.2 0 .5 0 .8.4.2.4.6 1.1.7 1.2.1.1.2.2.3.2.1.1.1.2.1.3 0 .2 0 .3 0 .4-.1.2-.3.5-.6.7-.2.2-.5.3-.6.4-.1.1-.2.1-.3.1s-.4 0-.9-.3c-.5-.3-.9-.6-1.1-.8-.1-.1-.4-.4-.5-.6-.1-.2-.1-.3-.1-.4s.1-.4.2-.6c.1-.2.4-.4.9-.3.4.1.9.4 1.2.6.3.2.8.5 1.2.6.4.1.7.2.9.3.2.1.4.2.5.2.1.1.1.1.1.2 0 .1-.1.1-.2.2z"/>
              </svg>
            </span>
